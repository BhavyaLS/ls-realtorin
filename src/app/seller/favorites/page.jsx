                    ...
                    <div className="flex-1 flex-col">
                        <div className="relative overflow-hidden group p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 mb-6">
                            ...
                            <div className="flex items-center justify-between relative z-10">
                                <div>
                                    <p className="text-sm font-medium text-blue-600 mb-1">Your Saved List</p>
                                ...
                                <div className='relative p-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl shadow-lg animate-float'>
                                    <TbHomeHeart className='text-3xl text-white transform rotate-45 transition-transform duration-500 group-hover:rotate-12' />
                                ...
                                {[1, 2, 3].map((item) => (
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <button className="absolute top-2 right-2 p-2 text-red-500 hover:text-red-600">
                                ...
                                {[1, 2, 3].map((item) => (
                                    ...
                                    >
                                        <div className="relative overflow-hidden">
                                            ...
                                            <button className="absolute top-2 right-2 p-1.5 bg-white rounded-full text-red-500 hover:text-red-600">
                                                <FaHeart className="w-6 h-6" />
                                            </button>
                                        </div>
